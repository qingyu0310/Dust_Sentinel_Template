...
- `D:\Zephyr_HPMicro\sdk_glue\dts\riscv\hpmicro\hpm5361.dtsi`
...
这条线最重要的不是新学一门课，而是把你刚看过的“链接/装载/内存布局”立刻应用到：
...
- 如果你想要 RTOS 共性补充：FreeRTOS 官方入门资料
...
以 Zephyr 官方文档和源码为主线，不要再把 FreeRTOS 当主线。
...
- 中国大学 MOOC / B站：`陈越 数据结构`

#### 当前阶段怎么用

你现在不要顺着把整门数据结构课刷完，只要优先补：
...
- B站：`哈工大 编译原理`
- Stanford `CS143: Compilers` 作为补充

#### 当前阶段怎么用

你现在不必优先啃词法/语法细节，而要先盯住：
...
- 《TCP/IP 详解》不适合当前这条线，先别上来就看网络大部头
- 当前更建议看各协议的官方手册和芯片手册章节
...
- LiteRT / TFLM microcontrollers overview
- LiteRT / TFLM get started
